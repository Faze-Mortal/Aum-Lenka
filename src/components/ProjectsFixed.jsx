  ...
  const projects = [
    {
      ...
      demoUrl: 'https://pixel-phrase-v5.vercel.app/',
      githubUrl: '#',
    ...
    },
    {
      id: 2,
      title: 'Project Aura',
      subtitle: 'AI-Powered Hand Gesture Controller',
      description: 'A client-side web app that enables real-time hand gesture control using modern browser APIs and on-device ML (MediaPipe) — privacy-first and blazing fast.',
      longDescription: 'Project Aura is a cutting-edge web application that demonstrates the future of human-computer interaction through real-time hand gesture control. Built entirely client-side, it showcases the power of modern browser APIs and machine learning models running locally on your device. Note: Project Aura is currently in BETA testing; expect occasional bugs and experimental features.',
      technologies: ['Privacy-first', 'React', 'MediaPipe', 'TensorFlow.js', 'Web APIs', 'Tailwind CSS', 'Vite'],
      features: [
        'Pointing: control cursor with index finger',
        'Pinch: grab/drag interactive elements',
        'Swipe: navigate between modes',
        'Open Palm: particle scattering in physics mode',
        'Cursor Mode: drag & drop with custom cursor',
        'Physics Mode: push particles with your palm',
        'Gallery Mode: swipe through images',
        'Privacy-first: all processing happens locally',
        'Real-time performance: ~20+ FPS hand tracking',
      ...
      demoUrl: 'https://aura-sigma-three.vercel.app/',
      githubUrl: 'https://github.com/Faze-Mortal/Aura',
      image: '/api/placeholder/600/400'
    },
    {
      id: 3,
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {project.beta && (
                        <span className="px-2 py-1 rounded-full text-[10px] border bg-yellow-500/20 text-yellow-300 border-yellow-500/30">
                          BETA
                        </span>
                      )}
                    </div>
                ...
                <div className="flex gap-3">
                  ...
                  {project.githubUrl && project.githubUrl !== '#' && (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 bg-gray-500/10 hover:bg-gray-500/20 text-gray-300 hover:text-white rounded-lg transition-colors text-sm font-medium border border-gray-500/30"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
